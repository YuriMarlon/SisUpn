...
$user_id=null;
$sql1= "SELECT * FROM usuario u JOIN persona p ON u.usu_id=p.usu_id JOIN docente d ON d.per_dni=p.per_dni where u.usu_id = '".$_SESSION["user_id"]."'";
    ...
    <form role="form" method="post" action="../../php/estudiante/actualizar.php" >
        <div class="container" style="padding: 0px">
            <div class="row">
                <div class="span4">
                    <div class="hero-unit">
                        <h2 class="le-mis-alertas">Datos del Docente</h2>
                        <div class="alert alert-info">                        
                            <span id="cp2_Label3"><strong>Recuerda</strong>: El cambio de nombres y apellidos debe contactarse con el Director de Carrera, siguiendo el procedimiento definido para ello.</span>
                        </div>                  
                        <div class="dvDatos">
                            <div class="AspNet-DetailsView">
                                <div class="AspNet-DetailsView-Data">
                                    <ul>
                                        <li>
                                            <span class="AspNet-DetailsView-Name">Código</span><span class="AspNet-DetailsView-Value"><?php echo $person->doc_codigo; ?></span>
                                        </li>
                                        <li class="AspNet-DetailsView-Alternate">
                                            <span class="AspNet-DetailsView-Name">Apellidos y nombres</span><span class="AspNet-DetailsView-Value"><?php echo $person->per_appaterno." ".$person->per_apmaterno." , ".$person->per_nombres; ?></span>
                                        </li>
                                        <li>
                                        ...
                                        <li class="AspNet-DetailsView-Alternate">
                                            <span class="AspNet-DetailsView-Name">Correo</span><span class="AspNet-DetailsView-Value"><?php echo $person->doc_correo; ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="AspNet-DetailsView-Data">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span class="AspNet-DetailsView-Value">						                
                                                <input name="ctl00$cp2$txtU" type="text" value='<?php echo $person->direccion; ?>' id="cp2_txtUrbanizacion" class="textboxSmall">
                                            </span>
                                        </li>
                                        <li>
                                            <span class="AspNet-DetailsView-Name">Teléfono fijo</span>
                                            <span class="AspNet-DetailsView-Value">						                
                                        ...
                                        <li>
                                            <span class="AspNet-DetailsView-Name">Teléfono celular</span>
                                            <span class="AspNet-DetailsView-Value">						                
