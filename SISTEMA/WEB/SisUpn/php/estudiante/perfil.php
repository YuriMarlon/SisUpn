...
$user_id=null;
$sql1= "select * from upn_usuarios u JOIN upn_estudiantes e ON u.id=e.idUsuario where u.id = ".$_SESSION["user_id"];
    ...
    <form role="form" method="post" action="../../php/estudiante/actualizar.php" >
        <div class="container" style="padding: 0px">
            <div class="row">
                <div class="span4">
                    <div class="hero-unit">
                        <h2 class="le-mis-alertas">Datos del Estudiante</h2>
                        ...
                        <div class="dvDatos">
                            <div class="AspNet-DetailsView">
                                <div class="AspNet-DetailsView-Data">
                                    <ul>
                                        <li>
                                            <span class="AspNet-DetailsView-Name">Código</span><span class="AspNet-DetailsView-Value"><?php echo $person->codigo; ?></span>
                                        </li>
